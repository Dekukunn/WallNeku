  ...
  Future<void> _fetchWallpapers() async {
    try {
      final fetchedWallpapers =
          await apiService.fetchWallpapers('Night'); // Filter 'Animals'
      if (!mounted) return; // Check if the widget is still mounted
      setState(() {
        nightWallpapers = fetchedWallpapers;
        isLoading = false;
      });
    } catch (e) {
      print('Error: $e');
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.grey[850],
           title: Text('Night Wallpaper',style: TextStyle(color: Colors.white),),
           leading: IconButton(
